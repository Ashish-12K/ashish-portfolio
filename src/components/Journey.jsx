    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.h2
          ...
          className="text-4xl font-bold text-center mb-16 relative w-fit mx-auto"
        >
          My <span className="text-teal-500">Journey</span>
          <span className="absolute left-1/2 -bottom-2 w-24 h-[3px] bg-teal-500 transform -translate-x-1/2 rounded"></span>
        </motion.h2>
        ...
        <div className="relative">
          ...
          {journeyData.map((item, index) => (
            <div key={index} className="mb-10 md:mb-14 relative">
              ...
              <motion.div
                ...
                className={`
                  w-[44%] md:w-[45%] p-3 md:p-5 rounded-xl shadow-md
              ...
              >
                ...
                <p className="text-xs md:text-sm text-gray-500 dark:text-gray-300 leading-tight md:leading-normal">
                  {item.desc}
                </p>
              </motion.div>

              {/* Dot */}
              <div className="absolute left-1/2 top-4 md:top-5 transform -translate-x-1/2 w-2 h-2 md:w-4 md:h-4 bg-teal-500 rounded-full border-2 md:border-4 border-white dark:border-gray-900"></div>
